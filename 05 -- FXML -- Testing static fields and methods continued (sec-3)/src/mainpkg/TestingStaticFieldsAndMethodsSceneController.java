...
public class TestingStaticFieldsAndMethodsSceneController implements Initializable {
    ...
    private Student s;
    private ResearchStudent rs;
    
    @FXML    private TextField noOfPublicationsTextField;
    @FXML    private TextField experienceDetailsTextField;
    ...
    private void viewAllFieldsButtonOnClick(ActionEvent event) {
        ...
        */
        outputLabel.setText( 
                "Student Info: "+ s.getStringEquivalent() + "\n\n"+
                "Research Student Info: "+rs.getResearchStudentStringEquivalent()
        );
    }
    ...
    @FXML
    private void createResearchStudentButtonOnClick(ActionEvent event) {
        rs = new ResearchStudent(
            Integer.parseInt(idTextField.getText()),
            nameTextField.getText(),
            Float.parseFloat(cgpaTextField.getText()),
            Integer.parseInt(noOfPublicationsTextField.getText()),
            experienceDetailsTextField.getText()
        );     
    }
